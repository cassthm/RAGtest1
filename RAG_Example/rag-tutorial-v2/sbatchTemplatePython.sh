...
#SBATCH --mail-user=hm.tan.2023@phdcs.smu.edu.sg # Who should receive the email notifications
#SBATCH --job-name=RAGtest    # Give the job a name
...
srun --gres=gpu:1 /common/scratch/users/h/hm.tan.2023/get_embedding_function.py
srun --gres=gpu:1 /common/scratch/users/h/hm.tan.2023/query_data.py "What is ICL"